1. Переходим в каталог с практикой, предварительно скинув туда файлы из данного каталога
...
- Готовый файл для этой самостоятельной работы лежит в этой же папке и называется     
  `docker-compose.yml_otvet`. Можно использовать как шпаргалку
